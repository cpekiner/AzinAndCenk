...
<body onload="crop('imgHi5', 'crop', 0, 0, 350, 70); crop('imgHi5', 'ibHi', 2, 585, 113, 36); crop('imgHi5', 'iFoot', 1, 659, 20, 20);">    
    ...
    <div id="formbox">
        <label>
            <asp:Label runat="server" ID="lName" Text="Name" />        
        ...
        <label> <asp:Label runat="server" ID="lEmail" Text="E-mail" />>
        ...
        <label><asp:Label runat="server" ID="lPassword" Text="Password" />
